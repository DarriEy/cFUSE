...
FALLBACK_PARAM_BOUNDS = {
    ...
    # Snow parameters
    'T_rain': (-2.0, 4.0),         # Rain threshold temperature (deg C)
    'T_melt': (-2.0, 4.0),         # Melt threshold temperature (deg C)
    'melt_rate': (1.0, 10.0),      # Degree-day factor (mm/deg C/day)
    'lapse_rate': (-9.8, 0.0),     # Temperature lapse rate (deg C/km)
