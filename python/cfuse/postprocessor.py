...
class CFUSEPostprocessor(StandardModelPostprocessor):
    ...
    output_file_pattern = "{domain}_cfuse_output.nc"
    ...
    # No resampling needed (cFUSE outputs daily)
    ...
    def _get_output_file(self):
        ...
        # Fall back to CSV
        csv_pattern = "{domain}_cfuse_output.csv"
...
class CFUSERoutedPostprocessor(StandardModelPostprocessor):
    ...
    Handles extraction from routing output files when cFUSE is used
    with external routing models.
    """

    model_name = "CFUSE_routed"
